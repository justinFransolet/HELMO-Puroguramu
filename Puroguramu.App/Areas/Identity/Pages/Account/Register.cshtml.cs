...
namespace Puroguramu.App.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<IdentityPuroguramuUser> _userStore;
        private readonly IUserEmailStore<IdentityPuroguramuUser> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<IdentityPuroguramuUser> userManager,
            IUserStore<IdentityPuroguramuUser> userStore,
        ...
        private IdentityPuroguramuUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<IdentityPuroguramuUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(IdentityPuroguramuUser)}'. " +
                    $"Ensure that '{nameof(IdentityPuroguramuUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<IdentityPuroguramuUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<IdentityPuroguramuUser>)_userStore;
        }
    }
}
